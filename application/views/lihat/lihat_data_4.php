                            ...
                            <table class="table table-striped table-hover" id="tbdata"> 
                                <thead> 
                                    <tr> 
                                        ...
                                        <th>Asal Bidang</th>
                                        <th>Nota Dinas</th>
                                        <th>Referensi Surat Masuk</th>
                                        <th width="10%">eArsip</th>
                                        <th width="10%">Aksi</th>
                                    </tr> 
                                </thead> 
                                <tbody> 
                                    <?php
                                        if(empty($surat)==false){
                                            ...
                                            foreach ($surat as $surat) {
                                                ...
                                                echo "<td>".$surat->nm_unker."</td>";
                                                echo "<td>".$surat->nomor_nodin."<br>".$surat->tgl_nodin."</td>";
                                                echo "<td>".$surat->ref_nomor_surat_masuk."<br>".$surat->ref_tgl_surat_masuk."<br>".$surat->ref_perihal_surat_masuk."</td>";
