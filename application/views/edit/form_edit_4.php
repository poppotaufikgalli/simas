                            ...
                            <div class="row">
                                <form id="frm_tambah" role="form" method="POST" action="<?Php echo base_url('index.php/simas/update/').$surat->kd_jns_surat.'/'.$surat->idx; ?>">
                                                ...
                                                if(empty($unker)==false){
                                                    ...
                                                    foreach ($unker as $unker) {
                                                        if(in_array($unker->kese, $ese)==true){
                                                            if($unker->kd_unker == $surat->asal_bidang){
                                                                echo "<option value='".$unker->kd_unker."' data-kd_bidang='".$unker->kd_bidang."' selected>".$unker->nm_unker."</option>";
                                                            }else{
                                    ...
                                    <div class="form-group col-lg-2">
                                        ...
                                        <input type="number" id="nomor_urut" name="nomor_urut" class="form-control" placeholder="Nomor Urut" required="" value="<?Php echo $surat->nomor_urut; ?>">
                                    </div>
                                    <div class="form-group col-lg-2">
                                        <label>Nomor Sisip</label>
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                                <input type="checkbox" id="set_sisip" name="set_sisip" value="<?Php if(empty($surat->nomor_sisip)==false){ echo "checked";} ?>">
                                            </span>
                                            <input type="text" id="nomor_sisip" name="nomor_sisip" class="form-control" placeholder="" readonly="" value="<?Php echo $surat->nomor_sisip; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-3">
                                        <label>Nomor Surat Keluar</label>
                                        <input type="text" id="nomor_surat" name="nomor_surat" class="form-control" readonly="" value="<?Php echo $surat->nomor_surat; ?>">
                                    </div>
                                    <div class="form-group col-lg-3">
                                    ...
                                    <div class="form-group col-lg-12">
                                        ...
                                        <input type="text" id="tujuan" name="tujuan" class="form-control" placeholder="Tujuan OPD Surat" required="" value="<?Php echo $surat->tujuan; ?>">
                                    </div>
                                    <div class="form-group col-lg-12">
                                        <label>Perihal</label>
                                        <textarea id="perihal" name="perihal" class="form-control" rows="2" required=""><?Php echo $surat->perihal; ?></textarea>
                                    </div>
                                    <div class="form-group col-lg-4">
                                        <label>Nomor Surat Masuk Terkait</label>
                                        <input type="hidden" id="ref_surat_masuk" name="ref_surat_masuk" class="form-control" required="" value="<?Php echo $surat->ref_surat_masuk; ?>">
                                        <div class="input-group">
                                    ...
                                    <div class="form-group col-lg-3">
                                        ...
                                        <input type="text" id="nomor_nodin" name="nomor_nodin" class="form-control" placeholder="Nomor Nota Dinas" value="<?Php echo $surat->nomor_nodin; ?>">
                                    </div>
                                    <div class="form-group col-lg-3">
                                        <label>Tanggal Nota Dinas</label>
                                        <input type="date" id="tgl_nodin" name="tgl_nodin" class="form-control" placeholder="Nomor Surat" value="<?Php echo $surat->tgl_nodin; ?>">
                                    </div>
